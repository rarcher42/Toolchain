...
# 10
("BPL",     (2,2,2,2,2,2), ("R")),          # BPL HERE         ;$10
("ORA",     (2,2,2,2,2,2), ("ZIY")),        # ORA ($42),y      ;$11
("ORA",     (2,2,2,2,2,0), ("ZI")),         # ORA ($42)        ;$12
("ORA",     (2,2,2,2,0,0), ("SIY")),        # ORA (1,S),Y      ;$13
("TRB",     (2,2,2,2,2,0), ("A")),          # TRB $19          ;$14
("ORA",     (2,2,2,2,2,2), ("ZX")),         # ORA $42,X        ;$15
("ASL",     (2,2,2,2,2,2), ("ZX")),         # ASL $43,X        ;$16
("ORA",     (2,2,2,2,0,0), ("ZILY")),       # ORA [$12],Y      ;$17
# 18
("CLC",     (1,1,1,1,1,1), ("-")),          # CLC              ;$18
("ORA",     (3,3,3,3,3,3), ("AY")),         # ORA $2A04,Y      ;$19
("INC A",   (1,1,1,1,1,0), ("-")),          # INC A            ;$1A
("TCS",     (1,1,1,1,0,0), ("-")),          # TCS              ;1B
("TRB",     (3,3,3,3,3,0), ("A")),          # TRB $1234        ;1C
("ORA",     (3,3,3,3,3,3), ("AX")),         # ORA $0300,X      ;1D
("ASL",     (3,3,3,3,3,3), ("AX")),         # ASL $4242,X      ;1E
("ORA",     (4,4,4,4,0,0), ("AXL")),        # ORA $402011,X    ;1F
# 20
("JSR",     (3,3,3,3,3,3), ("A")),          # JSR HERE         ;$20 
("AND",     (2,2,2,2,2,2), ("ZXI")),        # AND ($69,X)      ;21
("JSL",     (4,4,4,4,0,0), ("A")),          # JSL HERE         ;22
("AND",     (2,2,2,2,0,0), ("SR")),         # AND 1,S          ;23
("BIT",     (2,2,2,2,2,2), ("A")),          # BIT $20          ;24
("AND",     (2,2,2,2,2,2), ("A")),          # AND $30          ;25
("ROL",     (2,2,2,2,2,2), ("A")),          # ROL $12          ;26
("AND",     (2,2,2,2,0,0), ("ZIL")),        # AND [$10]        ;27
# 28
("PLP",     (1,1,1,1,1,1), ("-")),          # PLP              ;$28
("AND",     (3,3,2,2,2,2), ("N")),          # AND #$FE         ;$29
("ROL A",   (1,1,1,1,1,1), ("-")),          # ROL A            ;2A
...
#30          
("BMI",     (2,2,2,2,2,2), ("R")),          # BMI HERE         ;$30
("AND",     (2,2,2,2,2,2), ("ZIY")),        # AND ($20),Y      ;31
("AND",     (2,2,2,2,2,0), ("ZI")),         # AND ($20)        ;32
("AND",     (2,2,2,2,0,0), ("SIY")),        # AND (1,S),Y      ;33
("BIT",     (2,2,2,2,2,0), ("ZX")),         # BIT $20,X        ;34
("AND",     (2,2,2,2,2,2), ("ZX")),         # AND $21,X        ;35
("ROL",     (2,2,2,2,2,2), ("ZX")),         # ROL $69,X        ;36
("AND",     (2,2,2,2,0,0), ("ZILY")),       # AND [$30],Y      ;37
# 38
("SEC",     (1,1,1,1,1,1), ("-")),          # SEC              ;$38
("AND",     (3,3,3,3,3,3), ("AY")),         # AND $2A04,Y      ;39
("DEC A",   (1,1,1,1,1,0), ("-")),          # DEC A            ;3A
("TSC",     (1,1,1,1,0,0), ("-")),          # TSC              ;3B
("BIT",     (3,3,3,3,3,0), ("AX")),         # BIT $ABCD,X      ;3C
("AND",     (3,3,3,3,3,3), ("AX")),         # AND $1234,X      ;3D
("ROL",     (3,3,3,3,3,3), ("AX")),         # ROL $5150,X      ;3E
("AND",     (4,4,4,4,0,0), ("AXL")),        # AND $123456,X    ;3F
# 40
("RTI",     (1,1,1,1,1,1), ("-")),          # RTI              ;$40
("EOR",     (2,2,2,2,0,0), ("ZXI")),        # EOR ($22,X)      ;41
("WDM",     (2,2,2,2,0,0), ("N")),          # WDM #$AA         ;42
("EOR",     (2,2,2,2,0,0), ("SR")),         # EOR 1,S          ;43
("MVP",     (3,3,3,3,0,0), ("TWO")),        # MVP 1,2          ;44
("EOR",     (2,2,2,2,2,2), ("A")),          # EOR $12          ;45
("LSR",     (2,2,2,2,2,2), ("A")),          # LSR $33          ;46 
("EOR",     (2,2,2,2,0,0), ("ZIL")),        # EOR [$27]        ;47
# 48
("PHA",     (1,1,1,1,1,1), ("-")),          # PHA              ;$48
("EOR",     (3,3,2,2,2,2), ("N")),          # EOR #$FF         ;49
("LSR A",   (1,1,1,1,1,1), ("-")),          # LSR A            ;4A
...
# 50
("BVC",     (2,2,2,2,2,2), ("R")),          # BVC THERE        ;$50
("EOR",     (2,2,2,2,2,2), ("ZIY")),        # EOR ($21),Y      ;51
("EOR",     (2,2,2,2,2,0), ("ZI")),         # EOR ($25)        ;52
("EOR",     (2,2,2,2,0,0), ("SIY")),        # EOR (1,S),Y      ;53
("MVN",     (3,3,3,3,0,0), ("TWO")),        # MVN 3,4          ;54
("EOR",     (2,2,2,2,2,2), ("ZX")),         # EOR $19,X        ;55
("LSR",     (2,2,2,2,2,2), ("ZX")),         # LSR $18,X        ;56
("EOR",     (2,2,2,2,0,0), ("ZILY")),       # EOR [$42],Y      ;57
# 58
("CLI",     (1,1,1,1,1,1), ("-")),          # CLI              ;$58
("EOR",     (3,3,3,3,3,3), ("AY")),         # EOR $0200,Y      ;59
("PHY",     (1,1,1,1,1,0), ("-")),          # PHY              ;5A
("TCD",     (1,1,1,1,0,0), ("-")),          # TCD              ;5B
("JML",     (4,4,4,4,0,0), ("A")),          # JML $123456      ;5C
("EOR",     (3,3,3,3,3,3), ("AX")),         # EOR $1234,X      ;5D
("LSR",     (3,3,3,3,3,3), ("AX")),         # LSR $4231,X      ;5E
("EOR",     (4,4,4,4,0,0), ("AXL")),        # EOR $123456,X    ;5F
# 60
("RTS",     (1,1,1,1,1,1), ("-")),          # RTS              ;$60
("ADC",     (2,2,2,2,2,2), ("ZXI")),        # ADC ($50,X)      ;61
("PER",     (3,3,3,3,0,0), ("R")),          # PER THERE        ;62
("ADC",     (2,2,2,2,0,0), ("SR")),         # ADC 1,S          ;63
("STZ",     (2,2,2,2,2,0), ("A")),          # STZ $30          ;64
("ADC",     (2,2,2,2,2,2), ("A")),          # ADC $30          ;65
("ROR",     (2,2,2,2,2,2), ("A")),          # ROR $59          ;66
("ADC",     (2,2,2,2,0,0), ("ZIL")),        # ADC [$89]        ;67
# 68
("PLA",     (1,1,1,1,1,1), ("-")),          # PLA              ;$68
("ADC",     (3,3,2,2,2,2), ("N")),          # ADC #$23         ;69
("ROR A",   (1,1,1,1,1,1), ("-")),          # ROR A            ;6A
("RTL",     (1,1,1,1,0,0), ("-")),          # RTL              ;6B
("JMP",     (3,3,3,3,3,3), ("AI")),         # JMP ($FFFC)      ;6C
("ADC",     (3,3,3,3,3,3), ("A")),          # ADC $1234        ;6D
("ROR",     (3,3,3,3,3,3), ("A")),          # ROR $2345        ;6E
("ADC",     (4,4,4,4,0,0), ("A")),          # ADC $123456      ;6F
# 70
("BVS",     (2,2,2,2,2,2), ("R")),          # BVS THERE        ;$70
("ADC",     (2,2,2,2,2,2), ("ZIY")),        # ADC ($21),Y      ;71
("ADC",     (2,2,2,2,2,2), ("ZI")),         # ADC ($21)        ;72
("ADC",     (2,2,2,2,0,0), ("SIY")),        # ADC (1,S),Y      ;73
("STZ",     (2,2,2,2,2,0), ("ZX")),         # STZ $12,X        ;74
("ADC",     (2,2,2,2,2,2), ("ZX")),         # ADC $11,X        ;75
("ROR",     (2,2,2,2,2,2), ("ZX")),         # ROR $55,X        ;76
("ADC",     (2,2,2,2,0,0), ("ZILY")),       # ADC [$42],Y      ;77
# 78
("SEI",     (1,1,1,1,1,1), ("-")),          # SEI              ;78
("ADC",     (3,3,3,3,3,3), ("AY")),         # ADC $0100,Y      ;79
("PLY",     (1,1,1,1,1,0), ("-")),          # PLY              ;7A
("TDC",     (1,1,1,1,0,0), ("-")),          # TDC              ;7B
("JMP",     (3,3,3,3,3,0), ("AXI")),        # JMP ($8080,X)    ;7C
("ADC",     (3,3,3,3,3,3), ("AX")),         # ADC $1234,X      ;7D
("ROR",     (3,3,3,3,3,3), ("AX")),         # ROR $3456,X      ;7E
("ADC",     (4,4,4,4,0,0), ("AXL")),        # ADC $123456,X    ;7F
# 80
("BRA",     (2,2,2,2,2,0), ("R")),          # BRA T01          ;$80
("STA",     (2,2,2,2,2,2), ("ZXI")),        # STA ($00,X)      ;81
("BRL",     (3,3,3,3,0,0), ("R")),          # BRL T01          ;82
("STA",     (2,2,2,2,0,0), ("SR")),         # STA 1,S          ;83
("STY",     (2,2,2,2,2,2), ("A")),          # STY $21          ;84
("STA",     (2,2,2,2,2,2), ("A")),          # STA $64          ;85
("STX",     (2,2,2,2,2,2), ("A")),          # STX $99          ;86
("STA",     (2,2,2,2,0,0), ("ZIL")),        # STA [$55]        ;87
# 88
...
# 90
("BCC",     (2,2,2,2,2,2), ("R")),          # BCC T01          ;$90
("STA",     (2,2,2,2,2,2), ("ZIY")),        # STA ($22),Y      ;91
("STA",     (2,2,2,2,2,0), ("ZI")),         # STA ($AA)        ;92
("STA",     (2,2,2,2,0,0), ("SIY")),        # STA (1,S),Y      ;93
("STY",     (2,2,2,2,2,2), ("ZX")),         # STY $55,X        ;94
("STA",     (2,2,2,2,2,2), ("ZX")),         # STA $55,X        ;95
("STX",     (2,2,2,2,2,2), ("ZY")),         # STX $55,Y        ;96
("STA",     (2,2,2,2,0,0), ("ZILY")),       # STA [$42],Y      ;97
# 98
("TYA",     (1,1,1,1,1,1), ("-")),          # TYA              ;$98
("STA",     (3,3,3,3,3,3), ("AY")),         # STA $1200,Y      ;99
("TXS",     (1,1,1,1,1,1), ("-")),          # TXS              ;9A
("TXY",     (1,1,1,1,0,0), ("-")),          # TXY              ;9B
("STZ",     (3,3,3,3,3,0), ("A")),          # STZ $5150        ;9C
("STA",     (3,3,3,3,3,3), ("AX")),         # STA $0500,X      ;9D
("STZ",     (3,3,3,3,3,0), ("AX")),         # STZ $5555,X      ;9E
("STA",     (4,4,4,4,0,0), ("AXL")),        # STA $123456,X    ;9F
# A0
("LDY",     (3,2,3,2,2,2), ("N")),          # LDY #$44         ;$A0
("LDA",     (2,2,2,2,2,2), ("ZXI")),        # LDA ($27,X)      ;A1
("LDX",     (3,2,3,2,2,2), ("N")),          # LDX #$24         ;A2
("LDA",     (2,2,2,2,0,0), ("SR")),         # LDA 5,S          ;A3
("LDY",     (2,2,2,2,2,2), ("A")),          # LDY $55          ;A4
("LDA",     (2,2,2,2,2,2), ("A")),          # LDA $68          ;A5
("LDX",     (2,2,2,2,2,2), ("A")),          # LDX $88          ;A6
("LDA",     (2,2,2,2,0,0), ("ZIL")),        # LDA [$20]        ;A7
...
# B0
("BCS",     (2,2,2,2,2,2), ("R")),          # BCS T02          ;$B0  
("LDA",     (2,2,2,2,2,2), ("ZIY")),        # LDA ($88),Y      ;B1
("LDA",     (2,2,2,2,2,0), ("ZI")),         # LDA ($9A)        ;B2
("LDA",     (2,2,2,2,0,0), ("SIY")),        # LDA (3,S),Y      ;B3
("LDY",     (2,2,2,2,2,2), ("ZX")),         # LDY $50,X        ;B4
("LDA",     (2,2,2,2,2,2), ("ZX")),         # LDA $50,X        ;B5
("LDX",     (2,2,2,2,2,2), ("ZY")),         # LDX $50,Y        ;B6
("LDA",     (2,2,2,2,0,0), ("ZILY")),       # LDA [$40],Y      ;B7
# B8
("CLV",     (1,1,1,1,1,1), ("-")),          # CLV              ;$B8
("LDA",     (3,3,3,3,3,3), ("AY")),         # LDA $2525,Y      ;B9
("TSX",     (1,1,1,1,1,1), ("-")),          # TSX              ;BA
("TYX",     (1,1,1,1,0,0), ("-")),          # TYX              ;BB
("LDY",     (3,3,3,3,3,3), ("AX")),         # LDY $0211,X      ;BC
("LDA",     (3,3,3,3,3,3), ("AX")),         # LDA $2101,X      ;BD
("LDX",     (3,3,3,3,3,3), ("AY")),         # LDX $2012,Y      ;BE
("LDA",     (4,4,4,4,0,0), ("AXL")),        # LDA $123456,X    ;BF
# C0
("CPY",     (3,2,3,2,2,2), ("N")),          # CPY #$42         ;$C0
("CMP",     (2,2,2,2,2,2), ("ZXI")),        # CMP ($50,X)      ;C1
("REP",     (2,2,2,2,0,0), ("N")),          # REP #$30         ;C2
("CMP",     (2,2,2,2,0,0), ("SR")),         # CMP 1,S          ;C3
("CPY",     (2,2,2,2,2,2), ("A")),          # CPY $22          ;C4
("CMP",     (2,2,2,2,2,2), ("A")),          # CMP $33          ;C5
("DEC",     (2,2,2,2,2,2), ("A")),          # DEC $44          ;C6
("CMP",     (2,2,2,2,0,0), ("ZIL")),        # CMP [$42]        ;C7
# C8
...
# D0
("BNE",     (2,2,2,2,2,2), ("R")),          # BNE T03          ;$D0
("CMP",     (2,2,2,2,2,2), ("ZIY")),        # CMP ($00),Y      ;D1
("CMP",     (2,2,2,2,2,0), ("ZI")),         # CMP ($01)        ;D2
("CMP",     (2,2,2,2,0,0), ("SIY")),        # CMP (1,S),Y      ;D3
("PEI",     (2,2,2,2,0,0), ("A")),          # PEI $31          ;D4
("CMP",     (2,2,2,2,2,2), ("ZX")),         # CMP $99,X        ;D5
("DEC",     (2,2,2,2,2,2), ("ZX")),         # DEC $AA,X        ;D6
("CMP",     (2,2,2,2,0,0), ("ZILY")),       # CMP [$33],Y      ;D7
# D8
("CLD",     (1,1,1,1,1,1), ("-")),          # CLD              ;$D8
("CMP",     (3,3,3,3,3,3), ("AY")),         # CMP $3124,Y      ;D9
("PHX",     (1,1,1,1,1,0), ("-")),          # PHX              ;DA
("STP",     (1,1,1,1,1,0), ("-")),          # STP              ;DB
("JML",     (3,3,3,3,0,0), ("AIL")),        # JML [$1234]      ;DC
("CMP",     (3,3,3,3,3,3), ("AX")),         # CMP $5000,X      ;DD
("DEC",     (3,3,3,3,3,3), ("AX")),         # DEC $5150,X      ;DE
("CMP",     (4,4,4,4,0,0), ("AXL")),        # CMP $123456,X    ;DF
# E0
("CPX",     (3,2,3,2,2,2), ("N")),          # CPX #$FF         ;$E0
("SBC",     (2,2,2,2,2,2), ("ZXI")),        # SBC ($01,X)      ;E1
("SEP",     (2,2,2,2,0,0), ("N")),          # SEP #$00         ;E2
("SBC",     (2,2,2,2,0,0), ("SR")),         # SBC 1,S          ;E3
("CPX",     (2,2,2,2,2,2), ("A")),          # CPX $33          ;E4
("SBC",     (2,2,2,2,2,2), ("A")),          # SBC $99          ;E5
("INC",     (2,2,2,2,2,2), ("A")),          # INC $28          ;E6
("SBC",     (2,2,2,2,0,0), ("ZIL")),        # SBC [$42]        ;E7
# E8
...
# F0
("BEQ",     (2,2,2,2,2,2), ("R")),          # BEQ T03          ;$F0
("SBC",     (2,2,2,2,2,2), ("ZIY")),        # SBC ($94),Y      ;F1
("SBC",     (2,2,2,2,2,0), ("ZI")),         # SBC ($88)        ;F2
("SBC",     (2,2,2,2,0,0), ("SIY")),        # SBC (4,S),Y      ;F3
("PEA",     (3,3,3,3,0,0), ("N")),          # PEA T03          ;F4
("SBC",     (2,2,2,2,2,2), ("ZX")),         # SBC $44,X        ;F5
("INC",     (2,2,2,2,2,2), ("ZX")),         # INC $44,X        ;F6
("SBC",     (2,2,2,2,0,0), ("ZILY")),       # SBC [$42],Y      ;F7
# F8
("SED",     (1,1,1,1,1,1), ("-")),          # SED              ;$F8
("SBC",     (3,3,3,3,3,3), ("AY")),         # SBC $3141,Y      ;F9
("PLX",     (1,1,1,1,1,0), ("-")),          # PLX              ;FA
("XCE",     (1,1,1,1,0,0), ("-")),          # XCE              ;FB
("JSR",     (3,3,3,3,0,0), ("AXI")),        # JSR ($8085,X)    ;FC
("SBC",     (3,3,3,3,3,3), ("AX")),         # SBC $9980,X      ;FD
("INC",     (3,3,3,3,3,3), ("AX")),         # INC $9900,X      ;FE
("SBC",     (4,4,4,4,0,0), ("AXL"))         # SBC $123456,X    ;$FF
)
    ...
    def __init__(self, mode, offset, m):
        ...
        while pc < ea:
            ...
            if (len(op_admode) > 0):
                ...
                if op_admode == "TWO":
                    print(" %d,%d " % (to_hex(m[i+1:i+2]), to_hex(m[i+2:i+3])))
            print("\n")
            pc += oplen
