...
{"ORA", AL, LEN2|M_ADDS, OP_IMM, unimp},     //$09
...
{"AND", AL, LEN2|M_ADDS, OP_IMM, unimp},     //$29
...
{"EOR", AL, LEN2|M_ADDS, OP_IMM, unimp},     //$49
...
{"ADC", AL, LEN2|M_ADDS, OP_IMM, unimp},     //$69
...
{"BIT", AL, LEN2|M_ADDS, OP_IMM, unimp},     //$89
...
{"LDY", AL, LEN2|X_ADDS, OP_IMM, ldy},     //$A0
{"LDA", AL, LEN2, OP_ZP_XI, lda},    //$A1
{"LDX", AL, LEN2|X_ADDS, OP_IMM, ldx},     //$A2
...
{"LDA", AL, LEN2|M_ADDS, OP_IMM, lda},     //$A9
...
{"CPY", AL, LEN2|X_ADDS, OP_IMM, unimp},     //$C0
...
{"CMP", AL, LEN2|M_ADDS, OP_IMM, unimp},     //$C9
...
{"CPX", AL, LEN2|X_ADDS, OP_IMM, unimp},     //$E0
...
{"SBC", AL, LEN2|M_ADDS, OP_IMM, unimp},     //$E9
